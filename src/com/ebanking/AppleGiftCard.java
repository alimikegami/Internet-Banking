 ...
 * @author alimi
 */
public class AppleGiftCard extends JFrame {
    ...
    public AppleGiftCard(String username, String password, String accID) {
        ...
        clickBox1.setBackground(new Color(4, 133, 246));
        clickBox2.setBackground(new Color(4, 133, 246));
        clickBox3.setBackground(new Color(4, 133, 246));
        clickBox4.setBackground(new Color(4, 133, 246));
        clickBox5.setBackground(new Color(4, 133, 246));
        clickBox6.setBackground(new Color(4, 133, 246));
        ...
        JLabel label1 = new JLabel("USD 5");
        JLabel label2 = new JLabel("USD 10");
        JLabel label3 = new JLabel("USD 15");
        JLabel label4 = new JLabel("USD 25");
        JLabel label5 = new JLabel("USD 50");
        JLabel label6 = new JLabel("USD 100");
        ...
        ImageIcon img = new ImageIcon(getClass().getResource("/images/applesmall.png"));
        ...
        clickBox1.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox1.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox1.setBackground(new Color(96, 220, 255));
            ...
            @Override 
            public void mouseClicked(MouseEvent e) {
                PayAmount bayar = new PayAmount(username, password, accID, "81000", "Apple Gift Card Voucher IDR 81.000,00");
                dispose();
            }
        });
        ...
        clickBox2.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox2.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox2.setBackground(new Color(96, 220, 255));
            ...
            @Override 
            public void mouseClicked(MouseEvent e) {
                PayAmount bayar = new PayAmount(username, password, accID, "155000", "Apple Gift Card Voucher IDR 155.000,00");
                dispose();
            }
        });
        ...
        clickBox3.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox3.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox3.setBackground(new Color(96, 220, 255));
            ...
            @Override 
            public void mouseClicked(MouseEvent e) {
                PayAmount bayar = new PayAmount(username, password, accID, "231000", "Apple Gift Card Voucher IDR 231.000,00");
                dispose();
            }
        });
        ...
        clickBox4.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox4.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox4.setBackground(new Color(96, 220, 255));
            ...
            @Override 
            public void mouseClicked(MouseEvent e) {
                PayAmount bayar = new PayAmount(username, password, accID, "379000", "Apple Gift Card Voucher IDR 379.000,00");
                dispose();
            }
        });
        ...
        clickBox5.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox5.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox5.setBackground(new Color(96, 220, 255));
            ...
            @Override 
            public void mouseClicked(MouseEvent e) {
                PayAmount bayar = new PayAmount(username, password, accID, "755000", "Apple Gift Card Voucher IDR 755.000,00");
                dispose();
            }
        });
        ...
        clickBox6.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseEntered(MouseEvent e) {
                clickBox6.setBackground(new Color(0, 92, 200));
            ...
            @Override
            public void mousePressed(MouseEvent e) {
                clickBox6.setBackground(new Color(96, 220, 255));
